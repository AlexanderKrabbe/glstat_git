...
This is counter intuitive to me that I cannot just open any file or project existing in the directory that I have initialised a git repository in but I have to open a new project from an existing project from **within** Rstudio.
